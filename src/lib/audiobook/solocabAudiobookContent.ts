...
export const audiobookChapters: AudiobookChapter[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Au départ, cette commission est souvent modérée. C'est une stratégie classique : attirer un maximum d'utilisateurs, favoriser la croissance, atteindre une masse critique.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ce ressenti est souvent le résultat d'une combinaison de facteurs : l'augmentation des commissions, l'évolution des tarifs, la hausse des coûts opérationnels, la pression concurrentielle.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "On peut distinguer plusieurs phases. La phase de séduction, avec des commissions modérées et des conditions attractives.",
