...
export const guideChapters: GuideChapter[] = [
  ...
  // =========================================================
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Le modèle économique est simple : la plateforme fixe le prix, prend sa commission (entre 20 % et 30 %), et vous laisse assumer 100 % des charges. Essence, assurance, entretien du véhicule, cotisations sociales, URSSAF... tout est pour vous. Le bénéfice net, après déduction de toutes les charges, se situe souvent entre 5 € et 8 € de l'heure pour un chauffeur qui travaille exclusivement via ces plateformes.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Maintenant, comparons avec un chauffeur qui a constitué sa clientèle privée. Il fixe ses propres tarifs — généralement entre 2 € et 2,50 € du kilomètre. Il ne paie aucune commission. Sur une course de 30 km facturée 60 à 75 €, son bénéfice net est deux à trois fois supérieur à la même course via une plateforme.",
    ...
    actionBox: {
      ...
      steps: [
        "Calculez votre revenu net réel de la semaine dernière (CA brut - commissions - carburant - charges fixes quotidiennes).",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "La commission concierge : c'est une pratique courante dans le secteur. Proposez 5 € à 10 € par course au concierge qui vous recommande. C'est un investissement — pas une dépense. Un bon concierge peut vous générer 5 à 15 courses par mois.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Le terminal de paiement : un SumUp ou un lecteur similaire coûte entre 20 € et 40 € à l'achat, avec des commissions de 1,5 à 1,75 % par transaction. C'est un investissement indispensable — de nombreux clients n'ont plus de cash.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Constituez un réseau de 3 à 5 chauffeurs de confiance dans votre zone. Mêmes standards de qualité, même type de véhicule. Quand vous redirigez un client vers un partenaire, vous gardez la relation client et vous percevez une commission d'apport (5 à 10 € par course).",
