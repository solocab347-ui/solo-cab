      ...
      <div className="container max-w-2xl">
        <Card className="p-8 md:p-12 text-center bg-card border-border shadow-elegant">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">
            Paiement Pionniers Non Disponible
          </h1>
          ...
          <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-lg p-6 mb-8">
            ...
            <p className="text-amber-700 dark:text-amber-300 text-sm leading-relaxed">
              Le programme Pionniers est terminé. Les nouveaux paiements ne sont plus acceptés 
              via ce formulaire.
            </p>
          </div>

          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
            Si vous êtes déjà inscrit en tant que pionnier, veuillez vous connecter à votre 
            espace chauffeur pour gérer votre abonnement.
          </p>
