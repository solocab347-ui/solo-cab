...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      driver_course_incidents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "driver_course_incidents_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "driver_course_incidents_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
            referencedRelation: "driver_data_isolation"
            referencedColumns: ["driver_id"]
      ...
      settlement_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "settlement_alerts_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
            referencedRelation: "driver_data_isolation"
            referencedColumns: ["driver_id"]
          ...
          {
            foreignKeyName: "settlement_alerts_settlement_id_fkey"
            columns: ["settlement_id"]
            isOneToOne: false
            referencedRelation: "weekly_settlements"
            referencedColumns: ["id"]
      ...
      shared_courses: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shared_courses_pool_id_fkey"
            columns: ["pool_id"]
            isOneToOne: false
            referencedRelation: "partner_course_pool"
            referencedColumns: ["id"]
      ...
      stripe_anomalies: {
        ...
        Relationships: [
          {
            foreignKeyName: "stripe_anomalies_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "stripe_anomalies_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
            referencedRelation: "driver_data_isolation"
            referencedColumns: ["driver_id"]
    ...
    Functions: {
      ...
      claim_pool_course: {
        Args: { p_claimer_driver_id: string; p_pool_id: string }
        Returns: {
          course_id: string
          message: string
          success: boolean
      ...
      publish_course_to_pool: {
        Args: {
          p_also_broadcast_network?: boolean
          p_commission_percentage?: number
          p_course_id: string
          p_favorites_window_minutes?: number
          p_message?: string
          p_sender_driver_id: string
          p_target_favorite_ids?: string[]
        }
        Returns: {
          message: string
          pool_id: string
