  ...
  return (
    <div className="text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="mb-12 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="p-4 bg-white/5 border-white/10">
            ...
            <h4 className="font-semibold text-white mb-2">Recherchez</h4>
            <p className="text-sm text-gray-400">Trouvez un chauffeur proche de vous avec notre moteur de recherche</p>
          </Card>
          <Card className="p-4 bg-white/5 border-white/10">
            ...
            <h4 className="font-semibold text-white mb-2">Réservez</h4>
            <p className="text-sm text-gray-400">Contactez directement le chauffeur et réservez votre trajet</p>
          </Card>
          <Card className="p-4 bg-white/5 border-white/10">
            ...
            <h4 className="font-semibold text-white mb-2">Voyagez</h4>
            <p className="text-sm text-gray-400">Profitez de votre trajet en toute sérénité avec votre chauffeur</p>
          </Card>
        </div>
      </div>
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-pink-500/10 to-purple-600/10 border border-pink-500/20 max-w-3xl mx-auto">
        <h3 className="text-2xl font-bold text-white mb-3">Prêt à trouver votre chauffeur ?</h3>
        <p className="text-gray-400 mb-6">Inscrivez-vous gratuitement et accédez à tous les chauffeurs de votre région</p>
