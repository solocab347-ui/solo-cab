...
GRANT EXECUTE ON FUNCTION public.get_guest_booking_by_token(text) TO anon;
GRANT EXECUTE ON FUNCTION public.get_guest_booking_by_token(text) TO authenticated;
