...
-- Drop and recreate the function to include ALL newly registered drivers
-- Business rule: All drivers have 30 days after registration to complete their profile
-- During this period, their public profile should be accessible
