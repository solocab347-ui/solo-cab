...
BEGIN
  ...
  WITH candidate_drivers AS (
    ...
    WHERE d.public_profile_enabled = true
      ...
      AND (
        -- IMMEDIATE: online + available + GPS < 30s
        (v_mode = 'immediate'
        ...
        OR
        -- RESERVATION: online or busy drivers who accept future bookings, GPS < 5 min
        (v_mode = 'reservation'
          AND d.driver_status IN ('online', 'online_available', 'assigned', 'in_ride')
