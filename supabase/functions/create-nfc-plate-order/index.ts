...
// Prix des plaques NFC (prix plein, hors promo inscription) - Nouveau compte Stripe
const NFC_PLATE_PRICES = {
  small: {
    priceId: "price_1SuwqvAdFPYTU471lrv1hrEv",
  ...
  large: {
    priceId: "price_1SuwrGAdFPYTU471r5jB69qs",
