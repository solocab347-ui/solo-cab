          ...
          <body>
            <div class="container">
              <div class="content">
                ...
                <p>À l'issue de votre essai, l'abonnement est à seulement <strong>9,99€/mois</strong> - moins qu'une demi-course !</p>
          ...
          <body>
            <div class="container">
              <div class="content">
                ...
                <p><strong>Pour continuer à utiliser SoloCab</strong>, il vous suffit de souscrire à l'abonnement mensuel à 9,99€/mois (sans engagement).</p>
          ...
          <body>
            <div class="container">
              <div class="content">
                ...
                <ul>
                  <li>💳 Souscrivez à l'abonnement mensuel à 9,99€/mois</li>
                  <li>📅 Ou optez pour l'abonnement annuel à 101,90€/an (économisez 15%)</li>
